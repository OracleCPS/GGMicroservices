...
values ( 11 , 'Queso Cabrales ' , 5 , 4 , '1 kg pkg. ' , 21 , 22 , 30 , 30 , 0);
 ...
 insert into  products (  ProductID  , ProductName  , SupplierID  , CategoryID  , QuantityPerUnit  , UnitPrice  , UnitsInStock, UnitsOnOrder , ReorderLevel , Discontinued )
values ( 12 , 'Queso Manche  La Pastora ' , 5 , 4 , '10 - 500 g pkgs. ' , 38 , 86 , 0 , 0 , 0);
...
values ( 30 , 'Nord-Ost Matjeshering ' , 13 , 8 , '10 - 200 g glasses ' , 25.89 , 10 , 0 , 15 , 0);
 ...
 insert into  products (  ProductID  , ProductName  , SupplierID  , CategoryID  , QuantityPerUnit  , UnitPrice  , UnitsInStock, UnitsOnOrder , ReorderLevel , Discontinued )
values ( 31 , ' r nzola Telino ' , 14 , 4 , '12 - 100 g pkgs ' , 12.5 , 0 , 70 , 20 , 0);
...
values ( 57 , 'Ravioli Angelo ' , 26 , 5 , '24 - 250 g pkgs. ' , 19.5 , 36 , 0 , 20 , 0);
 ...
 insert into  products (  ProductID  , ProductName  , SupplierID  , CategoryID  , QuantityPerUnit  , UnitPrice  , UnitsInStock, UnitsOnOrder , ReorderLevel , Discontinued )
values ( 58 , 'Escar ts de Bour gne ' , 27 , 8 , '24 pieces ' , 13.25 , 62 , 0 , 20 , 0);
