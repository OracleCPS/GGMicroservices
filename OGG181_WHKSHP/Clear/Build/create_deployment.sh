...
cp /home/oracle/OGG181_WHKSHP/Lab8/Build/oggca_deployment.rsp /home/oracle/OGG181_WHKSHP/Lab9/Build/oggca_$vDName.rsp
...
cd $OGG_HOME/bin
./oggca.sh -silent -responseFile /home/oracle/OGG181_WHKSHP/Lab9/Build/oggca_$vDName.rsp

rm -f /home/oracle/OGG181_WHKSHP/Lab9/Build/oggca_$vDName.rsp
