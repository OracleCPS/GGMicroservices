...
cp /home/oracle/OGG181_WHKSHP/Reset/oggca_deployment_del.rsp /home/oracle/OGG181_WHKSHP/Reset/oggca_$vDName.rsp
...
${OGG_HOME}/bin/oggca.sh -silent -responseFile /home/oracle/OGG181_WHKSHP/Reset/oggca_$vDName.rsp

rm -f /home/oracle/OGG181_WHKSHP/Reset/oggca_$vDName.rsp
